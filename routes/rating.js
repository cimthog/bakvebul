    ...
    if (!req.body.artist_pub_id || !req.body.user_pub_id || !req.body.rating || !req.body.description||!req.body.invoice_id) {
        ...
        cm.getUserStatus(req.body.user_pub_id, function(err, result) {
            if (err) {
                ...
                con.query('select * from rating where invoice_id = "'+req.body.invoice_id+'" AND user_pub_id = "'+req.body.user_pub_id+'"', function(error, results) {
                    if(error){
                        ...
                        if(results == null || results == '' || results == undefined ){
                            ...
                            cm.responseMessage(constant.Zero,constant.alreadyRatingAdded,res)
                        }
                    }
