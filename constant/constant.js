module.exports = {
  ...
  FROM: "info@bakvebul.com",
  admin_support_mail: "bakvebul1@gmail.com",
  mailgun_api_key:"ef5924af46ea9c61c8e31f5c006ada8b-65b08458-d9013671",
  mailgun_domain:"mg.live2talks.com",
  //Verified Url
  VERIFIED_EMAIL: "http://178.62.60.63:4005/verify-email/",
  UPDATE_EMAIL: "http://178.62.60.63:4005/update_email/",
  ...
  EMAILALERADY: "Email id is already exist,please enter any other id.",
  ...
  CANT_APPLIED_JOB: "You can't applied for this Job because you are not artist.",
  APPLIED_JOB: "Job applied successfully.",
  Applied_job_title: "Job Applied.",
  APPLIED_JOB_MSG: "Applied on your job.",
  base_url_image: "http://178.62.60.63/",
  base_url: "http://178.62.60.63/",
  status: "status",
  message: "message",
  ...
  favourite_job: "Get all favourite jobs.",
  ...
  HELLO: "Hello ",
  REGISTRATION_TXT: "<br/> Thank you for registration with Bakvebul App. Please click on below link for verify you email address.",
  RGN: "Registration",
  email_update: "Update Email.",
  Thanks:"Thanks",
  SIGNATURE: "<br/> Thanks, <br/>Bakvebul Team",
  FRGPWD: "Forgot Password",
  All_Coupons: "Get All Coupons.",
  No_data: "No Data Found.",
  ADD_SERVICE: "Add Service Successfully.",
  getFannanPoint: "Get Bakvebul Point.",
  NOPOINT: "No Point Available.",
  AddedFannan: "Added Bakvebul Point Successfully.",
  ...
  //########
  alreadyRatingAdded:"Rating already added on this job",
  ticket_comment:'ticket comment',
  ticket_successfully_send_to_admin:"ticket successfully send to admin",
  ticket_title:"Ticket title",
  ticket_desc:"Ticket desciption",
  ticket_add_subject:"ticket add",
  ticket_received:"Ticket received from user",
  User_name:"User Name",
  User_email:'User Email',
  User_mobile:"User MobileNo",
  ticket_confirmation_title:"Ticket",
  ticket_confirmation_msg:"Ticket send successfully to admin",
  ticket_add_notification_type:"10015",
  ticket_comment_notification_type:"10016",
  User_Ticket_Resolved:'Ticket resolved',
  User_Ticket_cancelled:'Ticket cancelled',
  ticket_close_subject:"ticket closed",
  success:"Success",
  Error_In_Find:"Error In Find",
  null_data:"Data not found",
  invoice_not_found:"Invoice not found with this invoice id",
  error_in_artist_data_found:"Error in find artist data"
